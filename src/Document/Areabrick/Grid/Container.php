...
namespace App\Document\Areabrick\Grid;
...
#[AsAreabrick(id: 'container')]

/**
 * Class for new area brick container
 *
 ...
 */
class Container extends AbstractTemplateAreabrick
{
    public $identifier = 'container';
